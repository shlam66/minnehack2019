            ...
            <div id="home-text-div">
                <div id="why-hemptation">
                    ...
                    <div>
                        ...
                        <p>Contacts are a way to connect hemp farmers to buyers. By removing the middleman, it creates a 
                        transparent ecosystem where sellers communicate directly with the buyers. This ensures both 
                        parties know exactly what they're getting.</p>
                        <a href="/contracts"><button class="button is-secondary btn-why">Contracts</button></a>

                        <div class="small-header">Logs</div>
                        <p>Logs is a data recording tool that allows farmers to keep track of what works and what doesn't. 
                        Farmers can see other farmers crop strategies to increase their own crop yield.</p>
